...
REGISTER = {
    ...
    'tests/test_classify_cache_2054.py::test_a_symlink_planted_at_the_entry_name_is_refused_not_followed': B,
    'tests/test_coverage_gate_workdir_877.py::test_refuses_when_the_work_dir_path_is_a_symlink': B,
    'tests/test_dollar_var_path_1370.py::test_a_symlink_escape_is_still_refused': B,
    ...
    'tests/test_session_start_stale_symlink_2071.py::test_a_genuine_strangers_symlink_is_still_left_untouched': P,
    ...
    'tests/test_watch_channel_collision_2133.py::test_an_unreadable_marker_does_not_get_read_as_no_collision': B,
    'tests/test_watch_channel_collision_2133.py::test_an_unreadable_marker_is_not_the_same_absence_as_no_marker': B,
    'tests/test_watch_channel_collision_2133.py::test_health_says_something_when_the_marker_could_not_be_read': B,
