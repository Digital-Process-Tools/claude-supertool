...
- **Two genuine gaps, filed rather than worked around silently:** **#1083**, no op renders a _commit's_ run list (`gh-branch` answers for a branch head, not an arbitrary sha), and **#1084**, nothing tallies label distribution across open issues — the cohort burn-down this skill asks me to report every tick.
