...
**A capped merged page is `unknown`, not `not merged`** — the same rule the tracker column already applies to its own page, and it is not hypothetical: this repository held 399 merged PRs on 2026-08-10 against a cap of 400.
