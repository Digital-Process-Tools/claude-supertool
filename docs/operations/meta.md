...
| `ops:full` | `ops:full` | The same rows carrying their descriptions and examples — what `ops` was before #1774, ~82.27KB here. This is the full reference; nothing was deleted when the default changed. |
