...
| `ops` | `ops` | Every op's **signature** — built-in, custom and aliases — and nothing else, at ~4.2KB. Descriptions and examples moved to `ops:full` in #1774; `help:OP` carries one op's in full. An unrecognised argument is refused, not dropped. |
